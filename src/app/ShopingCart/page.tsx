...
const initialCartItems = [
  { name: "Burger", price: 10.99, quantity: 2, image: "/product-img.png" },
  { name: "Fresh Lime", price: 3.49, quantity: 1, image: "/product-img1.png" },
  { name: "Pizza", price: 9.99, quantity: 4, image: "/product-img2.png" },
  { name: "Chocolate Muffin", price: 4.49, quantity: 1, image: "/product-img3.png" },
  { name: "Cheese Butter", price: 11.99, quantity: 3, image: "/product-img4.png" },
];
...
const ShoppingCart: React.FC = () => {
  ...
  return (
    ...
    <div
      ...
      >
        <h1 className="text-white text-3xl font-bold">Shoping Cart</h1>
        <p className="text-white mt-2">
          <Link href="/" className="text-gray-300 hover:underline">
            Home
          </Link>{" "}
          <span className="text-orange-500">›</span>{" "}
          <span className="text-orange-500">Order Basket</span>
        </p>
      </div>
